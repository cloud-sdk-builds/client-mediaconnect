...
[`@aws-sdk/client-mediaconnect`](https://www.npmjs.com/package/@aws-sdk/client-mediaconnect/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediaconnect@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3bmHwbe98BArAfaBo0M1m7JE0FXH7Abjda17OOP9ULxKuJwCVPKZzi90wr0s+sOl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mediaconnect": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediaconnect@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediaconnect@3.983.0/index.min.mjs": "sha384-3bmHwbe98BArAfaBo0M1m7JE0FXH7Abjda17OOP9ULxKuJwCVPKZzi90wr0s+sOl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mediaconnect/blob/refs/tags/3.983.0/LICENSE
```
